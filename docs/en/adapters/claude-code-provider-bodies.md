# Claude Code Provider Bodies Internals

What the files [Claude Code Provider Bodies](../setup/claude-code-provider-bodies.md) collects hold,
and how asz lands and joins them.
