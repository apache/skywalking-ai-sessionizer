...
var glossary = model.NewGlossary(Dialect,
	...
	model.Term{Unified: model.RoleContinues, Note: "no equivalent: a marked summary names no last message before it"},
	...
	model.Term{Unified: model.KindEpoch, Note: "the span between two summaries SummarizationMiddleware marked"},
	...
	model.Term{Unified: model.KindEpochBoundary, Native: "additional_kwargs.lc_source: summarization",
		Where: "a message in the inputs of a run of type llm",
		Note:  "the first request sent a marked summary; trim_messages and langmem write no mark and make none"},
	model.Term{Unified: model.KindEpochSummary, Native: "kwargs.content",
		Where: "the marked message in the inputs of a run of type llm"},
	...
	model.Term{Unified: model.RelSummarizes, Note: "derived: the summary and its boundary come from one marked message"},
