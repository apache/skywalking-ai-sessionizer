...
//
//	go run ./tools/aptindex -dir APT_DIR PACKAGE.deb...
//
...
// again: tools/apt-repository.sh does both.
package main
...
func redirects(index map[string][]stanza, newest, current, archive string) []byte {
	var b bytes.Buffer
	b.WriteString(`# Written by tools/aptindex in apache/skywalking-ai-sessionizer. Do not edit it
# by hand: run tools/apt-repository.sh there.
#
