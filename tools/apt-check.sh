...
# amd64 and on arm64, and tools/apt-repository.sh runs it on released
# packages before it changes the website.
#
#   tools/apt-check.sh DIR VERSION...
#
...
#
# tools/aptindex writes the index one version at a time, oldest first, and a
...
[ "$#" -ge 2 ] || { echo "usage: tools/apt-check.sh DIR VERSION..." >&2; exit 2; }
